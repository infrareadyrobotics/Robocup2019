...
ballThresholds = [(33, 75, 43, 71, 26, 64)]
goalThresholds = [(30, 75, -5, 16, 22, 60),(10, 16, -11, 7, -33, -2)]
...
sensor.set_auto_whitebal(False, rgb_gain_db = (-8.2, -6, -1.2))
...
while(True):
    ...
    for blob in img.find_blobs(goalThresholds, pixels_threshold=30, area_threshold=30, x_stride=8, y_stride=8):
        if blob.code() == 1:
